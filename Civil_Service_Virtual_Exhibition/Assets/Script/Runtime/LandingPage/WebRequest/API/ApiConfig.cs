...
public class ApiConfig : ScriptableObject
{
    ...
    [Header("Quiz")]
    public string getQuizEndpoint = "/api/quiz/weekly";
    public string submitQuizEndpoint = "/api/game/quiz/submit";
    public string getQuizLeaderboardEndpoint = "/api/game/quiz/submit";
    ...
    public string GetQuizUrl => baseUrl + getQuizEndpoint;
    public string QuizSubmitUrl => baseUrl + submitQuizEndpoint;
    public string GetQuizLeaderboardUrl => baseUrl + getQuizLeaderboardEndpoint;
